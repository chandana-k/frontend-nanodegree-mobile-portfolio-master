...
var resizePizzas = function(size) {
  ...
  var domPizzaSize = document.getElementById("pizzaSize");
...
//optimized: pulled document.body reference and calculation out of for loop
// used window.scrollY / 1250 as const
//optimized: changed querySelectorAll to getElementsByClassName
//optimized: made phase an array to do 5 calculations once and then reference in for loop.
...
//optimized: originally found snippet on html5 rocks
//we are using this to make sure the updatePositions function isn't firing
//unnecessarily.
...
//optimized: reduced pizzas from 200 to 35
//optimized: changed querySelector to getelementbyid 
//and pulled out of for loop as const
//optimized: had to set the original left position of each element
//so that translateX could be used effectively in the updatePositions() function
